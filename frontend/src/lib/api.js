...
const resolveApiBase = () => {
  // Allow override via env (useful for production / different ports)
  ...
  // Development handling: If on localhost, always try port 4000 for backend
  // unless we are in production (which presumably uses same-origin or specific env)
  if (host === 'localhost' || host === '127.0.0.1') {
    return `${protocol}//127.0.0.1:4000/api`;
  }

  // Production/Other fallback: Same origin
